...
\title{\LARGE \bf
Projeto de um Sitema de Abastecimento Pluvial baseado em \textit{IoT} *
}

\author{ \parbox{3 in}{\centering Raphael Nunes$^{1}$; Israel Mazaira$^{2}$%
        \thanks{*Use the $\backslash$thanks command to put information here}\\
        Escola Superior de Tecnologia - EST\\
        
        Universidade do Estado Do Amazonas - UEA\\
        {\tt\small rdsn.eng16@uea.edu.br / imazaira@gmail.com}}
        \hspace*{ 0.5 in}
       
}

% \author{Raphael Nunes$^{1}$ e Israel Mazaira$^{2}$% <-this % stops a space
...
A região norte, possuindo a maior reserva de água potável do Brasil e também os maiores índices de precipitação, é a região que possui as taxas mais altas de desperdício (gloco.com, 2021). O desperdício pode ser encontrado no ambiente doméstico e nas várias etapas de: coleta, armazenamento, processamento e principalmente na distribuição do recurso. 
