...
\bstctlcite{IEEEexample:BSTcontrol}
    \title{Projeto de um Sistema de Abastescimento Pluvial Baseado em \textit{IoT}}
  \author{Raphael~Nunes,~\IEEEmembership{Student Member,~UEA,}
      Dr. Israel~Mazaira,~\IEEEmembership{Professor Member,~UEA,}\\% <-this % stops a space
